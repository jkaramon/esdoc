...
describe('MyClass1:', function () {
  ...
  it('has header notice.', function () {
    (0, _utilJs.find)(doc, '[data-ice="content"] .header-notice', function (doc) {
      ...
      _utilJs.assert.includes(doc, '[data-ice="source"] a', 'file/src/MyClass.js.html#lineNumber55', 'href');
  ...
  it('has self detail.', function () {
    (0, _utilJs.find)(doc, '[data-ice="content"] .self-detail', function (doc) {
      ...
      _utilJs.assert.includes(doc, 'code.lang-html', '<div>text</div>');

      (0, _utilJs.find)(doc, '[data-ice="exampleDocs"]', function (doc) {
        _utilJs.assert.includes(doc, 'div.example-doc:nth-of-type(1)', 'This is example caption');
        _utilJs.assert.includes(doc, 'div.example-doc:nth-of-type(1)', 'let foo = 10; let bar = 20;');

        _utilJs.assert.includes(doc, 'div.example-doc:nth-of-type(2)', 'for (let v of values) { let foo = v; }');
      });
    });
  });
