...
describe('MyTypedef:', function () {
  ...
  it('has summary.', function () {
    (0, _utilJs.find)(doc, '[data-ice="summary"]', function (doc) {
      ...
      _utilJs.assert.includes(doc, '[data-ice="target"]:nth-of-type(2)', 'public MyTypedefCallback1(p1: number, p2: string[]): function this is MyTypedefCallback1 desc.');
      _utilJs.assert.includes(doc, '[data-ice="target"]:nth-of-type(2) [data-ice="name"] a', 'typedef/index.html#static-typedef-MyTypedefCallback1', 'href');
    });
  });
  ...
  it('has detail.', function () {
    (0, _utilJs.find)(doc, '[data-ice="detail"]:nth-of-type(1)', function (doc) {
      ...
      (0, _utilJs.find)(doc, '[data-ice="properties"] [data-ice="properties"]', function (doc) {
        _utilJs.assert.includes(doc, '[data-ice="property"]:nth-of-type(1)', 'p1 number this is p1 desc.');
        _utilJs.assert.includes(doc, '[data-ice="property"]:nth-of-type(2)', 'p2 string[] this is p2 desc.');
      });
    });

    (0, _utilJs.find)(doc, '[data-ice="detail"]:nth-of-type(2)', function (doc) {
      _utilJs.assert.includes(doc, '#static-typedef-MyTypedefCallback1', 'public MyTypedefCallback1(p1: number, p2: string[]): function');
      (0, _utilJs.find)(doc, '[data-ice="properties"] [data-ice="properties"]', function (doc) {
        _utilJs.assert.includes(doc, '[data-ice="property"]:nth-of-type(1)', 'p1 number this is p1 desc.');
        _utilJs.assert.includes(doc, '[data-ice="property"]:nth-of-type(2)', 'p2 string[] this is p2 desc.');
      });
